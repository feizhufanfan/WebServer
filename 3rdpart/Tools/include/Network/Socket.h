...
#define TraceP(log,ptr) LOG_DBG(log,"%s(%s:%d)",ptr->getIdentifier().c_str(),ptr->get_peer_ip().c_str(),ptr->get_peer_port());
...
#define WarnP(log,ptr) LOG_WARN(log,"%s(%s:%d)",ptr->getIdentifier().c_str(),ptr->get_peer_ip().c_str(),ptr->get_peer_port());
